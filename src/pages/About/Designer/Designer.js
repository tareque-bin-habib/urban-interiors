        ...
        <div className='max-w-[1440px] mx-auto py-20'>
            <div className='grid xl:grid-cols-2 lg:grid-cols-2 md:grid-cols-1 sm:grid-cols-1 gap-24 py-10' data-aos="fade-down">
                <div className='flex justify-center'>
                    <div>
                        <h3 className='text-teal-500 text-sm font-bold'>WHO WE ARE</h3>
                ...
                <div>
                    <div className='flex xl:justify-start lg:justify-start md:justify-center sm:justify-center gap-10 pb-10'>
                        <div>
                            <FaBath className='text-4xl text-teal-500'></FaBath>
                        </div>
                        <div>
                    ...
                    <div className='flex xl:justify-start lg:justify-start md:justify-center sm:justify-center gap-10 pb-10'>
                        <div>
                            <FaShower className='text-4xl text-teal-500'></FaShower>
                        </div>
                        <div>
                    ...
                    <div className='flex xl:justify-start lg:justify-start md:justify-center sm:justify-center gap-10'>
                        <div>
                            <MdHotel className='text-4xl text-teal-500'></MdHotel>
                        </div>
                        <div>
