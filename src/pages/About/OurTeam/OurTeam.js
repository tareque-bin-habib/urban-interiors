    ...
    return (
        <div className='bg-gray-200'>
            <div className='max-w-[1440px] mx-auto py-20'>
                <h3 className='text-gray-500 text-xl font-bold text-center'>OUR TEAM MEMBERS</h3>
                <h1 className='text-5xl text-center font-bold py-3'>Our Creative Team</h1>
                <div className='grid xl:grid-cols-4 lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 gap-10 py-20'>
                    {
