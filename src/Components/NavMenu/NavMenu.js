        ...
        <div className='max-w-[1440px] mx-auto navMenu'>
            <div className="navbar">
                <div className="navbar-start">
...

                                {
                                    user?.uid ?
                                        <>
                                            ...
                                            <Link onClick={handleLogOut}><button className="btn bg-teal-500 font-bold rounded-xl text-white border-0">Sign out</button></Link>
                                        </>

                                        :
                                        <Link to='/login'><button className="btn bg-teal-500 font-bold rounded-xl text-white border-0">Login</button></Link>
                                }
                                {
                                    user?.photoURL ?
                    ...
                    <Link to='/' className="btn btn-ghost normal-case text-2xl font-bold text-teal-500">Urban Interior</Link>
                </div>
                ...
                <div className="navbar-end logedin">
                    ...
                    <label onClick={toggleDarkMode} className="swap swap-rotate ml-3">
